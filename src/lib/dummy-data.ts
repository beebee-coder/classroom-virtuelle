...
export const allDummyStudents: StudentWithStateAndCareer[] = [
    // --- Class A ---
    { id: 'student1', name: 'Ahmed', email: 'ahmed@example.com', points: 1250, ambition: 'Devenir Astronaute', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: 'password', role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat1', eleveId: 'student1', isPunished: false, metierId: 'astronaute', metier: dummyCareers[1], updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: studentProgress, sessionsParticipees: [] },
    { id: 'student2', name: 'Bilel', email: 'bilel@example.com', points: 980, ambition: 'Explorer les fonds marins', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat2', eleveId: 'student2', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student3', name: 'Fatima', email: 'fatima@example.com', points: 1500, ambition: 'Créer des jeux vidéo', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat3', eleveId: 'student3', isPunished: true, metierId: 'devjeux', metier: dummyCareers[2], updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student4', name: 'Khadija', email: 'khadija@example.com', points: 750, ambition: 'Devenir chef cuisinier', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat4', eleveId: 'student4', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student5', name: 'Youssef', email: 'youssef@example.com', points: 1100, ambition: 'Être un grand artiste', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat5', eleveId: 'student5', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student6', name: 'Amina', email: 'amina@example.com', points: 850, ambition: 'Protéger la nature', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat6', eleveId: 'student6', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student7', name: 'Omar', email: 'omar@example.com', points: 1300, ambition: 'Construire des robots', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat7', eleveId: 'student7', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student8', name: 'Leila', email: 'leila@example.com', points: 920, ambition: 'Soigner les animaux', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat8', eleveId: 'student8', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student9', name: 'Ibrahim', email: 'ibrahim@example.com', points: 1600, ambition: 'Devenir pompier', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat9', eleveId: 'student9', isPunished: false, metierId: 'pompier', metier: dummyCareers[0], updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student10', name: 'Nora', email: 'nora@example.com', points: 700, ambition: 'Voyager dans le temps', classroomId: 'classe-a', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat10', eleveId: 'student10', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-a', nom: 'Classe 6ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    // --- Class B ---
    { id: 'student11', name: 'Ali', email: 'ali@example.com', points: 1150, ambition: 'Piloter des avions', classroomId: 'classe-b', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat11', eleveId: 'student11', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-b', nom: 'Classe 6ème B', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student12', name: 'Sofia', email: 'sofia@example.com', points: 1050, ambition: 'Écrire des histoires', classroomId: 'classe-b', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat12', eleveId: 'student12', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-b', nom: 'Classe 6ème B', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    // ... add 8 more students for class B
    // --- Class C ---
    { id: 'student21', name: 'Zayd', email: 'zayd@example.com', points: 1000, ambition: 'Découvrir des trésors', classroomId: 'classe-c', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat21', eleveId: 'student21', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-c', nom: 'Classe 5ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
    { id: 'student22', name: 'Lina', email: 'lina@example.com', points: 1100, ambition: 'Dessiner des mangas', classroomId: 'classe-c', image: null, emailVerified: null, parentPassword: null, role: 'ELEVE', createdAt: new Date(), updatedAt: new Date(), etat: { id: 'etat22', eleveId: 'student22', isPunished: false, metierId: null, metier: null, updatedAt: new Date() }, classe: { id: 'classe-c', nom: 'Classe 5ème A', professeurId: 'teacher-id', createdAt: new Date(), updatedAt: new Date() }, progress: [], sessionsParticipees: [] },
