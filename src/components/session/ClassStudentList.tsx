                        ...
                        <CardContent className="space-y-2 pt-0 max-h-60 overflow-y-auto pr-4">
                            <TooltipProvider delayDuration={300}>
                                {sortedStudents.map((student) => {
                                    ...
                                    // ✅ CORRECTION : 'isInSession' inclut maintenant la vérification de la connexion WebRTC réussie.
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={cn(
                                                ...
                                                // ✅ CORRECTION : La couleur verte ne s'applique que si l'élève est bien en session.
