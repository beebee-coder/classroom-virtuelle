...
export default function RegisterForm() {
  ...
  useEffect(() => {
    ...
    if (status === 'authenticated') {
      router.push('/teacher/dashboard'); // Ou une page de profil générique
    }
  }, [status, router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Inscription réussie, maintenant on connecte l'utilisateur
      ...
      if (signInResult?.ok) {
        // La redirection sera gérée par la page de connexion ou le statut de la session
        router.push('/login');
      } else {
