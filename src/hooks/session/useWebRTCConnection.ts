...
export function useWebRTCConnection(sessionId: string, currentUserId: string, localStream: MediaStream | null, isComponentMounted: boolean, onStreamConnected: (userId: string, stream: MediaStream) => void, onStreamDisconnected: (userId: string) => void) {
