...
-- CreateEnum
CREATE TYPE "ProgressStatus" AS ENUM ('PENDING_VALIDATION', 'VERIFIED', 'REJECTED');

-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('DAILY', 'WEEKLY', 'MONTHLY');

-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('HOME', 'MATH', 'LANGUAGE', 'SCIENCE', 'ART', 'SPORT', 'OTHER', 'DEFAULT');
...
CREATE TABLE "StudentProgress" (
    ...
    "status" "ProgressStatus" NOT NULL DEFAULT 'PENDING_VALIDATION',
...
-- AddForeignKey
ALTER TABLE "SharedDocument" ADD CONSTRAINT "SharedDocument_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "CoursSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;
