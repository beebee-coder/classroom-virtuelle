...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('HOME', 'ART', 'SCIENCE', 'MATH', 'LANGUAGE', 'SPORT', 'SOCIAL');
...
-- AddForeignKey
ALTER TABLE "SharedDocument" ADD CONSTRAINT "SharedDocument_coursSessionId_fkey" FOREIGN KEY ("coursSessionId") REFERENCES "CoursSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
