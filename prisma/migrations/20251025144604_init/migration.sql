...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('MATH', 'SCIENCE', 'LANGUAGE', 'ART', 'SPORT', 'HOME');
...
-- AddForeignKey
ALTER TABLE "DocumentInHistory" ADD CONSTRAINT "DocumentInHistory_coursSessionId_fkey" FOREIGN KEY ("coursSessionId") REFERENCES "CoursSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
