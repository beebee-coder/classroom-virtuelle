...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('HOME', 'LANGUAGE', 'MATH', 'SCIENCE', 'ART', 'SPORT', 'SOCIAL');
...
-- CreateEnum
CREATE TYPE "ProgressStatus" AS ENUM ('PENDING', 'PENDING_VALIDATION', 'VERIFIED', 'REJECTED');
...
-- AddForeignKey
ALTER TABLE "classrooms" ADD CONSTRAINT "classrooms_professeurId_fkey" FOREIGN KEY ("professeurId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cours_sessions" ADD CONSTRAINT "cours_sessions_professeurId_fkey" FOREIGN KEY ("professeurId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cours_sessions" ADD CONSTRAINT "cours_sessions_classroomId_fkey" FOREIGN KEY ("classroomId") REFERENCES "classrooms"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "documents" ADD CONSTRAINT "documents_coursSessionId_fkey" FOREIGN KEY ("coursSessionId") REFERENCES "cours_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
