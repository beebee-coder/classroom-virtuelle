...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('MATH', 'SCIENCE', 'LANGUAGE', 'ART', 'HOME', 'SPORT');
...
-- AddForeignKey
ALTER TABLE "SharedDocument" ADD CONSTRAINT "SharedDocument_professeurId_fkey" FOREIGN KEY ("professeurId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
